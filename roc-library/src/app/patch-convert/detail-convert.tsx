...
console.log(f);
        // แปลงโค้ดสี RO → HTML
    f = f
      .replace(/\^start_L/g, `<span class="text-[#ff0000] line-through mr-2">`)
      .replace(/\^end_L/g, `</span>`)
      ...
      .replace(/\^000088/g, `<span class="text-[#000088]">`)
      .replace(/\^CC3D3D/g, `<span class="text-[#CC3D3D]">`)
